...
4. Учтите, что вы пишете не самостоятельные программы, а модули, инициализирующиеся при старте клиента. И все ваши глобальные объекты пытаются обращаться по REST, радостно при этом ломаясь. Поэтому код с глобальными объектами не принимается.
