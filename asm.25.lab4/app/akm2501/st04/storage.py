...
class SQLiteStorage:
    def __init__(self, db_path='data/akm2501/st04/company.db'):
    ...
    def save(self, filename):
        path = os.path.join('data/akm2501/st04', os.path.basename(filename))
    ...
    def load(self, filename):
        ...
        fake_modules = [
            ...
            'app.akm2501.st04.employee',
            'app.akm2501.st04.manager',
            'app.akm2501.st04.director',
            'app.akm2501.st04.io_strategy',
            'storage_strategy', 'app.akm2501.st04.storage_strategy',
        ]
